                ...
                <form name="search" action="#" method="post" class="search-form">
                    ...
                    <fieldset>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_qwerty">
                            Клавиатуры
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_muse">
                            Мыши
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_muse_mat">
                            Коврики для мыши
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_voltage_regulator">
                            Стабилизаторы напряжения
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_case_for_laptop">
                            Сумки для ноутбуков
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_case_for_pads">
                            Чехлы для планшетов
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_patron_glaces">
                            Защитные стекла и плёнки
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_power_supply">
                            Блоки питания
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_usb_concentration">
                            USB-концентраторы
                        </label>
                        <label class="flex-row">
                            <input type="checkbox" name="accessories[]" value="accessories_with_printer">
